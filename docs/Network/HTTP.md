...
"http://"称为"schema"，是 [URI](https://developer.mozilla.org/zh-CN/docs/Glossary/URI) 的组成部分，一般位于网络地址的开头。以"[https://developer.mozilla.org](https://developer.mozilla.org)"为例，该地址说明请求文档时使用 HTTP 协议；这里的 https 代指 HTTP 协议的安全版本，即 [SSL](https://developer.mozilla.org/zh-CN/docs/Glossary/SSL) （或称 TLS）
